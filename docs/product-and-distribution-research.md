...
There is a real but narrow niche, and there is already one near-exact competitor. Package ProfileBar as a small, free, notarized download outside the Mac App Store if the goal is to make a polished open-source utility. Do not invest in a Mac App Store submission or build a paid product yet.
